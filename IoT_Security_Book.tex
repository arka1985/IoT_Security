...
\title{
    \vspace{2cm}
    \Huge \textcolor{primary}{\textbf{IoT Cybersecurity Masterclass}}\\
    \vspace{0.5cm}
    \LARGE \textcolor{secondary}{\textit{From Vulnerable Bare Metal to Cryptographic Defense}}
    \vspace{2cm}
}
\author{
...
Welcome to the \textbf{IoT Cybersecurity Masterclass}. This massive textbook is designed heavily for educational purposes. To prevent truncations, this book incorporates the \textbf{UNABRIDGED} source code for every single demo level (1 through 10) provided in the accompanying course files. 
...
% ==========================================
\input{Chapter_01_Theory_Hardware.tex}
\input{Chapter_02_Level_1_to_3.tex}
\input{Chapter_03_Level_4_to_5.tex}
\input{Chapter_04_Level_6_Injection.tex}
\input{Chapter_05_Level_7_BasicAuth.tex}
\input{Chapter_06_Level_8_Lockouts.tex}
\input{Chapter_07_Level_9_Delays.tex}
\input{Chapter_08_Level_10_TOTP.tex}
